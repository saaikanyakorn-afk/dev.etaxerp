...
const SKIP_CLONE_TABLES = new Set(["session", "system_config", "schema_version", "clone_history", "machines", "machine_nics", "nic_ip_addresses", "routers", "router_domains", "platform_domains"]);
