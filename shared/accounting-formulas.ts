...
export const DEFAULT_FORMULAS: DefaultFormulaTemplate[] = [
  ...
  },
  {
    ...
    name: "E-Commerce Commission Reversal",
    nameTh: "กลับประมาณการค่าคอมมิชชั่น (ได้เอกสารจริง)",
  ...
  },
  {
    ...
    nameTh: "บันทึกค่าธรรมเนียมแพลตฟอร์ม",
    description: "ค่าธรรมเนียม Shopee/Lazada/TikTok และค่าขนส่ง SPX — VAT/non-VAT ผสม",
    lines: [
      { accountCode: "5241000", accountName: "ค่าธรรมเนียมแพลตฟอร์ม", direction: "debit", sortOrder: 1 },
      { accountCode: "1432000", accountName: "ภาษีซื้อ", direction: "debit", sortOrder: 2 },
      { accountCode: "2101000", accountName: "เจ้าหนี้การค้า", direction: "credit", sortOrder: 3 },
    ],
  },
