...
export const DEFAULT_FORMULAS: DefaultFormulaTemplate[] = [
  ...
  },
  {
    ...
    nameTh: "บันทึกค่าธรรมเนียม Shopee (ใบ TIV)",
    description: "ค่าธรรมเนียม Shopee — แยก Commission, Service Fee, ค่าโฆษณา + ภาษีซื้อ",
    lines: [
      { accountCode: "5241000", accountName: "ค่าคอมมิชชั่น Shopee", direction: "debit", sortOrder: 1 },
      ...
      { accountCode: "2101000", accountName: "เจ้าหนี้การค้า", direction: "credit", sortOrder: 5 },
    ],
  },
  {
    documentType: "purchase",
    businessType: "shopee_shipping",
    name: "SPX Express Shipping Fee",
    nameTh: "บันทึกค่าขนส่ง SPX Express (ใบ RCT)",
    description: "ค่าขนส่ง SPX Express — ไม่มี VAT, หัก ณ ที่จ่าย 1%",
    lines: [
      { accountCode: "5265000", accountName: "ค่าขนส่ง SPX Express", direction: "debit", sortOrder: 1 },
      { accountCode: "2101000", accountName: "เจ้าหนี้การค้า", direction: "credit", sortOrder: 2 },
    ],
  },
  {
    documentType: "purchase",
    ...
    nameTh: "บันทึกค่าธรรมเนียม Lazada (ใบ THMPTI)",
    description: "ค่าธรรมเนียม Lazada — แยก Commission, Service Fee, ค่าโฆษณา + ภาษีซื้อ",
    lines: [
      { accountCode: "5242000", accountName: "ค่าคอมมิชชั่น Lazada", direction: "debit", sortOrder: 1 },
  ...
  },
  {
    ...
    name: "Lazada Express Shipping Fee",
    nameTh: "บันทึกค่าขนส่ง Lazada Express (ใบ THLPTI)",
    description: "ค่าขนส่ง Lazada Express — ไม่มี VAT, หัก ณ ที่จ่าย 1%",
    lines: [
  ...
  },
  {
    ...
    nameTh: "บันทึกค่าธรรมเนียม TikTok (ใบ TTSTH)",
    description: "ค่าธรรมเนียม TikTok Shop — แยก Commission, BCD/FS, Infrastructure, ค่าโฆษณา + ภาษีซื้อ",
    lines: [
      { accountCode: "5243000", accountName: "ค่าคอมมิชชั่น TikTok Shop", direction: "debit", sortOrder: 1 },
  ...
  },
  {
    ...
    name: "TikTok Logistics Fee",
    nameTh: "บันทึกค่าขนส่ง TikTok (ใบ THJV)",
    description: "ค่าขนส่ง Thai Happy Logistics — ไม่มี VAT, หัก ณ ที่จ่าย 1%",
    lines: [
