    ...
    return `<!DOCTYPE html><html><head><meta charset="utf-8"><title>รายงานภาษีซื้อ</title>
      ...
      <table>
        ...
        <tbody>
          ${tableRows}
          <tr class="total-row">
            <td colspan="8" style="text-align:right;border:1px solid #ccc;padding:4px 8px;font-size:12px">รวมทั้งสิ้น</td>
            ...
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div className="flex items-center gap-2 text-xs flex-wrap">
                ...
                <Select value={filterBranch || "__all__"} onValueChange={(v) => setFilterBranch(v === "__all__" ? "" : v)}>
                  <SelectTrigger className="w-36 h-8 bg-white border rounded-lg" data-testid="select-filter-branch">
                ...
                <Select value={filterDepartment || "__all__"} onValueChange={(v) => setFilterDepartment(v === "__all__" ? "" : v)}>
                  <SelectTrigger className="w-36 h-8 bg-white border rounded-lg" data-testid="select-filter-dept">
                ...
                <Select value={filterSalesperson || "__all__"} onValueChange={(v) => setFilterSalesperson(v === "__all__" ? "" : v)}>
                  <SelectTrigger className="w-36 h-8 bg-white border rounded-lg" data-testid="select-filter-person">
